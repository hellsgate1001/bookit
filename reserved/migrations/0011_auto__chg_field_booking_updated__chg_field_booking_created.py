...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Booking.updated'
        db.alter_column(u'reserved_booking', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'Booking.created'
        db.alter_column(u'reserved_booking', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Booking.updated'
        raise RuntimeError("Cannot reverse this migration. 'Booking.updated' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Booking.updated'
        db.alter_column(u'reserved_booking', 'updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # User chose to not deal with backwards NULL issues for 'Booking.created'
        raise RuntimeError("Cannot reverse this migration. 'Booking.created' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Booking.created'
        db.alter_column(u'reserved_booking', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
