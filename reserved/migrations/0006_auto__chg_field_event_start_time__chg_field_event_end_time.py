...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reserved_event', 'start_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Event.end_time'
        db.alter_column(u'reserved_event', 'end_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Event.start_time'
        db.alter_column(u'reserved_event', 'start_time', self.gf('django.db.models.fields.DateTimeField')(default=''))

        # Changing field 'Event.end_time'
        db.alter_column(u'reserved_event', 'end_time', self.gf('django.db.models.fields.DateTimeField')(default=''))
