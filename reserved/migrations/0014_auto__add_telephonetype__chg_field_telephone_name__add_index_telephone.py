...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Telephone.name' to match new field type.
        db.rename_column(u'reserved_telephone', 'name', 'name_id')
        # Changing field 'Telephone.name'
        db.alter_column(u'reserved_telephone', 'name_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reserved.TelephoneType']))
        # Adding index on 'Telephone', fields ['name']
        db.create_index(u'reserved_telephone', ['name_id'])


    def backwards(self, orm):
        # Removing index on 'Telephone', fields ['name']
        db.delete_index(u'reserved_telephone', ['name_id'])
        ...
        # Renaming column for 'Telephone.name' to match new field type.
        db.rename_column(u'reserved_telephone', 'name_id', 'name')
        # Changing field 'Telephone.name'
        db.alter_column(u'reserved_telephone', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))
