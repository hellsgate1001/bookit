...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bookit_location', u'id')

        # Adding field 'Location.address_ptr'
        db.add_column(u'bookit_location', u'address_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default='', to=orm['easy_maps.Address'], unique=True, primary_key=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Location.id'
        db.add_column(u'bookit_location', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)

        # Deleting field 'Location.address_ptr'
        db.delete_column(u'bookit_location', u'address_ptr_id')
    ...
    models = {
        ...
        u'bookit.company': {
            ...
            'addresses': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['bookit.Location']", 'symmetrical': 'False'}),
