...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bookit_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'bookit', ['Location'])

        # Adding model 'Company'
        db.create_table(u'bookit_company', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'bookit', ['Company'])

        # Adding M2M table for field addresses on 'Company'
        m2m_table_name = db.shorten_name(u'bookit_company_addresses')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('company', models.ForeignKey(orm[u'bookit.company'], null=False)),
            ('location', models.ForeignKey(orm[u'bookit.location'], null=False))
        ))
        db.create_unique(m2m_table_name, ['company_id', 'location_id'])

        # Adding M2M table for field contact on 'Company'
        m2m_table_name = db.shorten_name(u'bookit_company_contact')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('company', models.ForeignKey(orm[u'bookit.company'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'bookit_location')

        # Deleting model 'Company'
        db.delete_table(u'bookit_company')

        # Removing M2M table for field addresses on 'Company'
        db.delete_table(db.shorten_name(u'bookit_company_addresses'))

        # Removing M2M table for field contact on 'Company'
        db.delete_table(db.shorten_name(u'bookit_company_contact'))
