...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'account_userprofile', (
            ...
            ('middle_names', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('deleted_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['account.UserProfile'])),
        ...
        m2m_table_name = db.shorten_name(u'account_userprofile_groups')
        ...
        m2m_table_name = db.shorten_name(u'account_userprofile_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'account.userprofile'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'account_userprofile_groups'))

        # Removing M2M table for field user_permissions on 'UserProfile'
        db.delete_table(db.shorten_name(u'account_userprofile_user_permissions'))
