...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReservedProfile'
        db.create_table(u'account_reservedprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='my_profile', unique=True, to=orm['account.UserProfile'])),
        ))
        db.send_create_signal(u'account', ['ReservedProfile'])


    def backwards(self, orm):
        # Deleting model 'ReservedProfile'
        db.delete_table(u'account_reservedprofile')


    models = {
        u'account.reservedprofile': {
            'Meta': {'object_name': 'ReservedProfile'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mugshot': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'privacy': ('django.db.models.fields.CharField', [], {'default': "'closed'", 'max_length': '15'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'my_profile'", 'unique': 'True', 'to': u"orm['account.UserProfile']"})
        },
